...
export const DIAGNOSIS_TEMPLATES: Record<string, DiagnosisTemplate> = {
  ...
  "Chronic Kidney Disease": {
    ...
    templateType: "Opinion Report",
    diagnoses: [
      { name: "CKD Stage 1", icdCode: "N18.1", icdName: "Chronic kidney disease, stage 1" },
      { name: "CKD Stage 2", icdCode: "N18.2", icdName: "Chronic kidney disease, stage 2 (mild)" },
      { name: "CKD Stage 3", icdCode: "N18.3", icdName: "Chronic kidney disease, stage 3 (moderate)" },
      { name: "CKD Stage 4", icdCode: "N18.4", icdName: "Chronic kidney disease, stage 4 (severe)" },
      { name: "CKD Stage 5", icdCode: "N18.5", icdName: "Chronic kidney disease, stage 5" },
      { name: "End-stage renal disease", icdCode: "N18.6", icdName: "End-stage renal disease" },
    ],
