...
export const MOCK_DIAGNOSES: DiagnosisEntry[] = [
  ...
  { id: 'n33.8', name: 'Bladder disorders in other diseases classified elsewhere', icdCode: 'N33.8', icdName: 'Bladder disorders in other diseases classified elsewhere', clinicalNames: ['Bladder disorders in diseases classified elsewhere'] },
